...
# ---------------------------------------------------------------------------
# Command registry / execution endpoints
# ---------------------------------------------------------------------------

COMMAND_REGISTRY: List[Dict[str, Any]] = [
    {"name": "help", "description": "Show available commands and usage", "category": "System"},
    {"name": "status", "description": "Show gateway status, model, and session info", "category": "System"},
    {"name": "model", "description": "Show the active model, provider, and context length", "category": "Model"},
    {"name": "new", "description": "Start a new chat session", "category": "Session"},
    {"name": "clear", "description": "Clear the current chat transcript", "category": "Session"},
    {"name": "sessions", "description": "List recent sessions", "category": "Session"},
    {"name": "stop", "description": "Stop the current streaming response", "category": "System"},
    {"name": "spawn", "description": "Spawn a background agent with a prompt", "category": "Tools", "args_hint": "<prompt>"},
    {"name": "agents", "description": "List running background agents", "category": "Tools"},
    {"name": "skills", "description": "List and toggle available skills", "category": "Skills"},
    {"name": "cron", "description": "List scheduled cron jobs", "category": "Cron"},
    {"name": "config", "description": "Show current configuration", "category": "Configuration"},
]


@app.get("/api/commands")
async def list_commands(_: None = Depends(_require_auth)):
    """Return the slash-command palette shown in the Terminal drawer menu."""
    return {"commands": COMMAND_REGISTRY}
